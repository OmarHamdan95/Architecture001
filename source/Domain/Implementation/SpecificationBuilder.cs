...
public abstract class SpecificationBuilder<T> : ISpecification<T>
{
    ...
    public bool HasPredicate { get; protected set; }
...
public class AndSpecification<T> : SpecificationBuilder<T>
{
    ...
    public override Expression<Func<T, bool>> Predicate
    {
        get { return _left.Predicate != null ? And(_left.Predicate, _right.Predicate) : _right.Predicate; }
    }
...
public class OrSpecification<T> : SpecificationBuilder<T>
{
    ...
    public override Expression<Func<T, bool>> Predicate
    {
        get { return _left.Predicate != null ? Or(_left.Predicate, _right.Predicate) : _right.Predicate; }
    }
...
public class NotSpecification<T> : SpecificationBuilder<T>
{
    ...
    public override Expression<Func<T, bool>> Predicate
    {
        get { return Not(_left.Predicate); }
    }
